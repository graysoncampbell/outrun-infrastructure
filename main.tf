...
locals {
  ...
  mongodb_atlas_api_pub_key = vars.mongodb_atlas_api_pub_key
  mongodb_atlas_api_pri_key = vars.mongodb_atlas_api_pri_key
  mongodb_atlas_org_id  = vars.mongodb_atlas_org_id
  ...
  mongodb_atlas_database_username = vars.mongodb_atlas_database_username
  mongodb_atlas_database_user_password = vars.mongodb_atlas_database_user_password
  ...
  mongodb_atlas_accesslistip = vars.mongodb_whitelist
}
